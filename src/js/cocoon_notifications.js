    ...
    */
    ...
    Cocoon.define("Cocoon.Notification", function(extension) {
        ...
        * Unregisters the application from receiving push notifications
         ...
         * @property {string}   Cocoon.Notification.NotificationInfo.icon (Optional) Name of the custom icon that you have bundled in the application as a resource (You will need a custom Cordova plugin to bundle resources in the app).
         */
